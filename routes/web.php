...
$app->group('/auth', function (): void {
    ...
    $this->route(['GET', 'POST'], '/register', App\Http\Controllers\Auth\RegisterController::class)
        ->add(new App\Http\Middleware\GuestMiddleware($this->getContainer()))
        ->add(new App\Http\Middleware\RequiresSecureRequestMiddleware($this->getContainer()))
        ->setName('auth.register');

    $this->route(['GET'], '/settings', App\Http\Controllers\Auth\SettingsController::class)
        ->add(new App\Http\Middleware\AuthMiddleware($this->getContainer()))
        ->add(new App\Http\Middleware\RequiresSecureRequestMiddleware($this->getContainer()))
        ->setName('auth.settings');

    $this->route(['GET', 'POST'], '/settings/profile', App\Http\Controllers\Auth\SettingsController::class, 'profile')
        ->add(new App\Http\Middleware\AuthMiddleware($this->getContainer()))
        ->add(new App\Http\Middleware\RequiresSecureRequestMiddleware($this->getContainer()))
        ->setName('auth.settings.profile');

    $this->route(['GET', 'POST'], '/settings/password', App\Http\Controllers\Auth\SettingsController::class, 'password')
        ->add(new App\Http\Middleware\AuthMiddleware($this->getContainer()))
        ->add(new App\Http\Middleware\RequiresSecureRequestMiddleware($this->getContainer()))
        ->setName('auth.settings.password');
    ...
    $this->route(['GET', 'POST'], '/password/forgot', App\Http\Controllers\Auth\PasswordResetController::class, 'forgot')
        ->add(new App\Http\Middleware\RequiresSecureRequestMiddleware($this->getContainer()))
        ->add(new App\Http\Middleware\GuestMiddleware($this->getContainer()))
        ->setName('auth.password.forgot');

    $this->route(['GET', 'POST'], '/password/reset', App\Http\Controllers\Auth\PasswordResetController::class, 'reset')
        ->add(new App\Http\Middleware\GuestMiddleware($this->getContainer()))
        ->add(new App\Http\Middleware\RequiresSecureRequestMiddleware($this->getContainer()))
